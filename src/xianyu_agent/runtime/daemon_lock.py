"""Cross-platform singleton lock for the runtime daemon."""
...
class DaemonAlreadyRunningError(RuntimeError):
    """Raised when another daemon process already owns the singleton lock."""


class DaemonLock:
    """Hold a non-blocking file lock for the daemon lifetime."""
